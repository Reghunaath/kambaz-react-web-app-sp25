export default function Lab1() {
  return (
    <div id="wd-lab1">
      ...
      <br />
      Class: CS5610.35649.202530
      <br />
      <a
        href="https://a1--reghu-kambaz-react-web-app-sp25.netlify.app/"
        id="wd-lipsum"
      >
        Kambaz Assignment 1
      </a>
      <br />
      <a
        href="https://reghu-kambaz-react-web-app-sp25.netlify.app/"
        id="wd-lipsum"
      >
        Kambaz Main branch
      </a>
      <br />
      <a
        href="https://github.com/Reghunaath/kambaz-react-web-app-sp25"
        id="wd-lipsum"
      >
        Source Code
      </a>
      ...
      <div id="wd-lists">
        ...
        My favorite recipe(omelette):
        <ol id="wd-your-favorite-recipe">
          <li>Crack and beat the egss.</li>
          <li>Mix chopped veggies.</li>
          <li>Pour it on a pan.</li>
          <li>Once it's done, serve it hot.</li>
        </ol>
      </div>
      ...
      <ul id="wd-your-books">
        <li>One Flew Over the Cuckoo's Nest Novel by Ken Kesey</li>
      ...
      <div id="wd-tables">
        ...
        <table border={1} width="100%">
          ...
          <tbody>
            ...
            <tr>
              <td>Q7</td>
              <td>HTML: Tokyo Drift</td>
              <td>3/6/21</td>
              <td>85</td>
            </tr>
            <tr>
              <td>Q8</td>
              <td>CSS: Tokyo Drift</td>
              <td>3/11/21</td>
              <td>90</td>
            </tr>
            <tr>
              <td>Q9</td>
              <td>JS: Tokyo Drift</td>
              <td>3/16/21</td>
              <td>95</td>
            </tr>
            <tr>
              <td>Q10</td>
              <td>The Fate of Web Development</td>
              <td>3/21/21</td>
              <td>90</td>
            </tr>
          </tbody>
